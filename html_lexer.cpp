...
HTMLTagType getTagType(ConstStr tag)
{
	// tag\-=std::string\(\"([a-z])([a-z]*)\"\)
	// tag[0]=='\1' && (tag-=std::string("\1\2"))
	char tag0 = tag[0];
	if (tag0=='!' && (tag-=std::string("!doctype"))) return TAG_DOCTYPE;
	else if (tag0=='a' && (tag0=='a' && (tag-=std::string("a")))) return TAG_A;
	else if (tag0=='a' && (tag-=std::string("abbr"))) return TAG_ABBR;
	else if (tag0=='a' && (tag-=std::string("acronym"))) return TAG_ACRONYM;
	else if (tag0=='a' && (tag-=std::string("address"))) return TAG_ADDRESS;
	else if (tag0=='a' && (tag-=std::string("applet"))) return TAG_APPLET;
	else if (tag0=='a' && (tag-=std::string("area"))) return TAG_AREA;
	else if (tag0=='a' && (tag-=std::string("article"))) return TAG_ARTICLE;
	else if (tag0=='a' && (tag-=std::string("aside"))) return TAG_ASIDE;
	else if (tag0=='a' && (tag-=std::string("audio"))) return TAG_AUDIO;
	else if (tag0=='b' && (tag-=std::string("b"))) return TAG_B;
	else if (tag0=='b' && (tag-=std::string("base"))) return TAG_BASE;
	else if (tag0=='b' && (tag-=std::string("basefont"))) return TAG_BASEFONT;
	else if (tag0=='b' && (tag-=std::string("bdi"))) return TAG_BDI;
	else if (tag0=='b' && (tag-=std::string("bdo"))) return TAG_BDO;
	else if (tag0=='b' && (tag-=std::string("big"))) return TAG_BIG;
	else if (tag0=='b' && (tag-=std::string("blockquote"))) return TAG_BLOCKQUOTE;
	else if (tag0=='b' && (tag-=std::string("body"))) return TAG_BODY;
	else if (tag0=='b' && (tag-=std::string("br"))) return TAG_BR;
	else if (tag0=='b' && (tag-=std::string("button"))) return TAG_BUTTON;
	else if (tag0=='c' && (tag-=std::string("canvas"))) return TAG_CANVAS;
	else if (tag0=='c' && (tag-=std::string("caption"))) return TAG_CAPTION;
	else if (tag0=='c' && (tag-=std::string("center"))) return TAG_CENTER;
	else if (tag0=='c' && (tag-=std::string("cite"))) return TAG_CITE;
	else if (tag0=='c' && (tag-=std::string("code"))) return TAG_CODE;
	else if (tag0=='c' && (tag-=std::string("col"))) return TAG_COL;
	else if (tag0=='c' && (tag-=std::string("colgroup"))) return TAG_COLGROUP;
	else if (tag0=='d' && (tag-=std::string("datalist"))) return TAG_DATALIST;
	else if (tag0=='d' && (tag-=std::string("dd"))) return TAG_DD;
	else if (tag0=='d' && (tag-=std::string("del"))) return TAG_DEL;
	else if (tag0=='d' && (tag-=std::string("details"))) return TAG_DETAILS;
	else if (tag0=='d' && (tag-=std::string("dfn"))) return TAG_DFN;
	else if (tag0=='d' && (tag-=std::string("dialog"))) return TAG_DIALOG;
	else if (tag0=='d' && (tag-=std::string("dir"))) return TAG_DIR;
	else if (tag0=='d' && (tag-=std::string("div"))) return TAG_DIV;
	else if (tag0=='d' && (tag-=std::string("dl"))) return TAG_DL;
	else if (tag0=='d' && (tag-=std::string("dt"))) return TAG_DT;
	else if (tag0=='e' && (tag-=std::string("em"))) return TAG_EM;
	else if (tag0=='e' && (tag-=std::string("embed"))) return TAG_EMBED;
	else if (tag0=='f' && (tag-=std::string("fieldset"))) return TAG_FIELDSET;
	else if (tag0=='f' && (tag-=std::string("figcaption"))) return TAG_FIGCAPTION;
	else if (tag0=='f' && (tag-=std::string("figure"))) return TAG_FIGURE;
	else if (tag0=='f' && (tag-=std::string("font"))) return TAG_FONT;
	else if (tag0=='f' && (tag-=std::string("footer"))) return TAG_FOOTER;
	else if (tag0=='f' && (tag-=std::string("form"))) return TAG_FORM;
	else if (tag0=='f' && (tag-=std::string("frame"))) return TAG_FRAME;
	else if (tag0=='f' && (tag-=std::string("frameset"))) return TAG_FRAMESET;
	else if (tag0=='h' && (tag-=std::string("head"))) return TAG_HEAD;
	else if (tag0=='h' && (tag-=std::string("header"))) return TAG_HEADER;
	...
	else if (tag0=='h' && (tag-=std::string("hr"))) return TAG_HR;
	else if (tag0=='h' && (tag-=std::string("html"))) return TAG_HTML;
	else if (tag0=='i' && (tag-=std::string("i"))) return TAG_I;
	else if (tag0=='i' && (tag-=std::string("iframe"))) return TAG_IFRAME;
	else if (tag0=='i' && (tag-=std::string("img"))) return TAG_IMG;
	else if (tag0=='i' && (tag-=std::string("input"))) return TAG_INPUT;
	else if (tag0=='i' && (tag-=std::string("ins"))) return TAG_INS;
	else if (tag0=='k' && (tag-=std::string("kbd"))) return TAG_KBD;
	else if (tag0=='k' && (tag-=std::string("keygen"))) return TAG_KEYGEN;
	else if (tag0=='l' && (tag-=std::string("label"))) return TAG_LABEL;
	else if (tag0=='l' && (tag-=std::string("legend"))) return TAG_LEGEND;
	else if (tag0=='l' && (tag-=std::string("li"))) return TAG_LI;
	else if (tag0=='l' && (tag-=std::string("link"))) return TAG_LINK;
	else if (tag0=='m' && (tag-=std::string("main"))) return TAG_MAIN;
	else if (tag0=='m' && (tag-=std::string("map"))) return TAG_MAP;
	else if (tag0=='m' && (tag-=std::string("mark"))) return TAG_MARK;
	else if (tag0=='m' && (tag-=std::string("menu"))) return TAG_MENU;
	else if (tag0=='m' && (tag-=std::string("menuitem"))) return TAG_MENUITEM;
	else if (tag0=='m' && (tag-=std::string("meta"))) return TAG_META;
	else if (tag0=='m' && (tag-=std::string("meter"))) return TAG_METER;
	else if (tag0=='n' && (tag-=std::string("nav"))) return TAG_NAV;
	else if (tag0=='n' && (tag-=std::string("noframes"))) return TAG_NOFRAMES;
	else if (tag0=='n' && (tag-=std::string("noscript"))) return TAG_NOSCRIPT;
	else if (tag0=='o' && (tag-=std::string("object"))) return TAG_OBJECT;
	else if (tag0=='o' && (tag-=std::string("ol"))) return TAG_OL;
	else if (tag0=='o' && (tag-=std::string("optgroup"))) return TAG_OPTGROUP;
	else if (tag0=='o' && (tag-=std::string("option"))) return TAG_OPTION;
	else if (tag0=='o' && (tag-=std::string("output"))) return TAG_OUTPUT;
	else if (tag0=='p' && (tag-=std::string("p"))) return TAG_P;
	else if (tag0=='p' && (tag-=std::string("param"))) return TAG_PARAM;
	else if (tag0=='p' && (tag-=std::string("pre"))) return TAG_PRE;
	else if (tag0=='p' && (tag-=std::string("progress"))) return TAG_PROGRESS;
	else if (tag0=='q' && (tag-=std::string("q"))) return TAG_Q;
	else if (tag0=='r' && (tag-=std::string("rp"))) return TAG_RP;
	else if (tag0=='r' && (tag-=std::string("rt"))) return TAG_RT;
	else if (tag0=='r' && (tag-=std::string("ruby"))) return TAG_RUBY;
	else if (tag0=='s' && (tag-=std::string("s"))) return TAG_S;
	else if (tag0=='s' && (tag-=std::string("samp"))) return TAG_SAMP;
	else if (tag0=='s' && (tag-=std::string("script"))) return TAG_SCRIPT;
	else if (tag0=='s' && (tag-=std::string("section"))) return TAG_SECTION;
	else if (tag0=='s' && (tag-=std::string("select"))) return TAG_SELECT;
	else if (tag0=='s' && (tag-=std::string("small"))) return TAG_SMALL;
	else if (tag0=='s' && (tag-=std::string("source"))) return TAG_SOURCE;
	else if (tag0=='s' && (tag-=std::string("span"))) return TAG_SPAN;
	else if (tag0=='s' && (tag-=std::string("strike"))) return TAG_STRIKE;
	else if (tag0=='s' && (tag-=std::string("strong"))) return TAG_STRONG;
	else if (tag0=='s' && (tag-=std::string("style"))) return TAG_STYLE;
	else if (tag0=='s' && (tag-=std::string("sub"))) return TAG_SUB;
	else if (tag0=='s' && (tag-=std::string("summary"))) return TAG_SUMMARY;
	else if (tag0=='s' && (tag-=std::string("sup"))) return TAG_SUP;
	else if (tag0=='t' && (tag-=std::string("table"))) return TAG_TABLE;
	else if (tag0=='t' && (tag-=std::string("tbody"))) return TAG_TBODY;
	else if (tag0=='t' && (tag-=std::string("td"))) return TAG_TD;
	else if (tag0=='t' && (tag-=std::string("textarea"))) return TAG_TEXTAREA;
	else if (tag0=='t' && (tag-=std::string("tfoot"))) return TAG_TFOOT;
	else if (tag0=='t' && (tag-=std::string("th"))) return TAG_TH;
	else if (tag0=='t' && (tag-=std::string("thead"))) return TAG_THEAD;
	else if (tag0=='t' && (tag-=std::string("time"))) return TAG_TIME;
	else if (tag0=='t' && (tag-=std::string("title"))) return TAG_TITLE;
	else if (tag0=='t' && (tag-=std::string("tr"))) return TAG_TR;
	else if (tag0=='t' && (tag-=std::string("track"))) return TAG_TRACK;
	else if (tag0=='t' && (tag-=std::string("tt"))) return TAG_TT;
	else if (tag0=='u' && (tag-=std::string("u"))) return TAG_U;
	else if (tag0=='u' && (tag-=std::string("ul"))) return TAG_UL;
	else if (tag0=='v' && (tag-=std::string("var"))) return TAG_VAR;
	else if (tag0=='v' && (tag-=std::string("video"))) return TAG_VIDEO;
	else if (tag0=='w' && (tag-=std::string("wbr"))) return TAG_WBR;
